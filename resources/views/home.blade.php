        ...
        <div class="container-fluid">
            <div class="row">
            	<div class="col-10 col-sm-8 col-md-5 col-lg-4">
                    ...
                    <p class="phone-no"><i class="anm anm-phone-s"></i> +94 74 030 8478</p>
                </div>
                <div class="col-sm-4 col-md-4 col-lg-4 d-none d-lg-none d-md-block d-lg-block">
                	<div class="text-center"><p class="top-header_middle-text"> Islandwide Delivery</p></div>
                </div>
                ...
                <div class="col-4 col-sm-3 col-md-3 col-lg-2">
                	<div class="site-cart">
                        ...
                        <div id="header-cart" class="block block-cart">
                            ...
                            <div class="total">
                            	<div class="total-in">
                                	<span class="label">Cart Subtotal:</span><span class="product-price"><span class="money">Rs.748.00</span></span>
                                </div>
        	...
        	<div class="home-slideshow">
            	<div class="slide">
                	<div class="blur-up lazyload bg-size">
                        <img class="blur-up lazyload bg-img" data-src="assets/images/slideshow-banners/backgroundimg1.png" src="assets/images/slideshow-banners/backgroundimg1.png" alt="Shop Our New Collection" title="Shop Our New Collection" />
                        <div class="slideshow__text-wrap slideshow__overlay classic bottom">
                            <div class="slideshow__text-content bottom">
                                <div class="wrap-caption center">
                                        <h2 class="h1 mega-title slideshow__title">Shop Our New Unifrom Collection</h2>
                                        <span class="mega-subtitle slideshow__subtitle">Get ahead with the right uniform from our Store</span>
                ...
                <div class="slide">
                	<div class="blur-up lazyload bg-size">
                        <img class="blur-up lazyload bg-img" data-src="assets/images/slideshow-banners/belle-banner2.jpg" src="assets/images/slideshow-banners/bg2.jpg" alt="Summer Bikini Collection" title="Summer Bikini Collection" />
                        <div class="slideshow__text-wrap slideshow__overlay classic bottom">
                            <div class="slideshow__text-content bottom">
                                <div class="wrap-caption center">
                                    <h2 class="h1 mega-title slideshow__title">Year End Seasonal Unifrom Collection</h2>
                	...
                	<div class="col-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="tabs-listing">
                            <ul class="tabs clearfix">
                                <li class="active" rel="tab1">Girls</li>
                                <li rel="tab2">Boys</li>
                                <li rel="tab3">Other Products</li>
                            </ul>
                                    ...
                                    <div class="productSlider">
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="short-description.html">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload" data-src="assets/images/product-images/ld1(2).jpg" src="assets/images/product-images/ld1(2).jpg" alt="image" title="product">
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload" data-src="assets/images/product-images/ld1(1).jpg" src="assets/images/product-images/ld1(1).jpg" alt="image" title="product">
                                                    <!-- End hover image -->
                                                    <!-- product label -->
                                            ...
                                            <div class="product-details text-center">
                                                ...
                                                <div class="product-name">
                                                    <a href="short-description.html">Girl’s School Uniform Frock – GSC</a>
                                                </div>
                                                <!-- End product name -->
                                                <!-- product price -->
                                                <div class="product-price">
                                                    <span class="old-price">LKR 1195.00 - LKR 1995.00</span>
                                                    <span class="price">LKR 1095.00 - LKR 1895.00</span>
                                                </div>
                                                <!-- End product price -->
                                        ...
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="short-description.html">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload" data-src="assets/images/product-images/Ig2(1).jpg" src="assets/images/product-images/Ig2(1).jpg" alt="image" title="product">
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload" data-src="assets/images/product-images/Ig2(2).jpg" src="assets/images/product-images/Ig2(2).jpg" alt="image" title="product">
                                                    <!-- End hover image -->
                                                </a>
                                                <!-- end product image -->
                                            ...
                                            <div class="product-details text-center">
                                                <!-- product name -->
                                                <div class="product-name">
                                                    <a href="short-description.html">Girl’s School Uniform Frock – Normal Pleat</a>
                                                </div>
                                                <!-- End product name -->
                                                <!-- product price -->
                                                <div class="product-price">
                                                    <span class="price">LKR 1195.00 - LKR 2095.00</span>
                                                </div>
                                                <!-- End product price -->
                                                <div class="product-review">
                                                    <i class="font-13 fa fa-star"></i>
                                        ...
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="short-description.html">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload" data-src="assets/images/product-images/Ig3(1).jpg" src="assets/images/product-images/Ig3(1).jpg" alt="image" title="product">
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload" data-src="assets/images/product-images/Ig3(2).jpg" src="assets/images/product-images/Ig3(2).jpg" alt="image" title="product">
                                                    <!-- End hover image -->
                                                    <!-- product label -->
                                                    <div class="product-labels rectangular"><span class="lbl pr-label2">Out of Stock</span></div>
                                                    <!-- End product label -->
                                                </a>
                                                <!-- end product image -->
                                            ...
                                            <div class="product-details text-center">
                                                <!-- product name -->
                                                <div class="product-name">
                                                    <a href="short-description.html">Girl's School Uniform Frock - Museus</a>
                                                </div>
                                                <!-- End product name -->
                                                <!-- product price -->
                                                <div class="product-price">
                                                    <span class="price">LKR 1095.00 - LKR 1995.00</span>
                                                </div>
                                                <!-- End product price -->
                                        ...
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="short-description.html">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload" data-src="assets/images/product-images/Ig4(1).jpg" src="assets/images/product-images/Ig4(1).jpg" alt="image" title="product" />
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload" data-src="assets/images/product-images/Ig2(2).jpg" src="assets/images/product-images/Ig2(2).jpg" alt="image" title="product" />
                                                    <!-- End hover image -->
                                            ...
                                            <div class="product-details text-center">
                                                <!-- product name -->
                                                <div class="product-name">
                                                    <a href="short-description.html">Girl’s School Uniform Frock – Anula Vidyalaya</a>
                                                </div>
                                                <!-- End product name -->
                                                <!-- product price -->
                                                <div class="product-price">
                                                    <span class="old-price">LKR 1095.00 - LKR 1795.00</span>
                                                    <span class="price">LKR 995.00 - LKR 1695.00</span>
                                                </div>
                                                <!-- End product price -->
                                        ...
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="short-description.html">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload" data-src="assets/images/product-images/Ig5(1).jpg" src="assets/images/product-images/Ig5(1).jpg" alt="image" title="product" />
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload" data-src="assets/images/product-images/Ig3(2).jpg" src="assets/images/product-images/Ig3(2).jpg" alt="image" title="product" />
                                                    <!-- End hover image -->
                                            ...
                                            <div class="product-details text-center">
                                                <!-- product name -->
                                                <div class="product-name">
                                                    <a href="short-description.html">Girl's School Uniform Frock - 5 Pleat</a>
                                                </div>
                                                <!-- End product name -->
                                                <!-- product price -->
                                                <div class="product-price">
                                                    <span class="price">LKR 1195.00 - LKR 1995.00</span>
                                                </div>
                                                <!-- End product price -->
                                    ...
                                    <div class="productSlider">
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="short-description.html">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload" data-src="assets/images/product-images/boy2(1).jpg" src="assets/images/product-images/boy2(1).jpg" alt="image" title="product">
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload" data-src="assets/images/product-images/boy2(2).jpg" src="assets/images/product-images/boy2(2).jpg" alt="image" title="product">
                                                    <!-- End hover image -->
                                                    <!-- product label -->
                                                    <div class="product-labels rectangular"><span class="lbl on-sale">-16%</span> <span class="lbl pr-label1">new</span></div>
                                                    <!-- End product label -->
                                            ...
                                            <div class="product-details text-center">
                                                <!-- product name -->
                                                <div class="product-name">
                                                    <a href="short-description.html">Boy School Uniform Shirt - Short Sleeve</a>
                                                </div>
                                                <!-- End product name -->
                                                <!-- product price -->
                                                <div class="product-price">
                                                    <span class="price">LKR 895.00 - LKR 1495.00</span>
                                                </div>
                                                <!-- End product price -->
                                        ...
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="short-description.html">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload" data-src="assets/images/product-images/boy1(1).jpg" src="assets/images/product-images/boy1(1).jpg" alt="image" title="product">
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload" data-src="assets/images/product-images/boy1(2).jpg" src="assets/images/product-images/boy1(2).jpg" alt="image" title="product">
                                                    <!-- End hover image -->
                                                </a>
                                                <!-- end product image -->
                                            ...
                                            <div class="product-details text-center">
                                                <!-- product name -->
                                                <div class="product-name">
                                                    <a href="short-description.html">Boy School Uniform Short - Elasticated</a>
                                                </div>
                                                <!-- End product name -->
                                                <!-- product price -->
                                                <div class="product-price">
                                                    <span class="price">LKR 995.00 - LKR 1495.00</span>
                                                </div>
                                                <!-- End product price -->
                                                <div class="product-review">
                                                    <i class="font-13 fa fa-star"></i>
                                        ...
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="short-description.html">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload" data-src="assets/images/product-images/boy3(1).jpg" src="assets/images/product-images/boy3(1).jpg" alt="image" title="product">
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload" data-src="assets/images/product-images/boy3(2).jpg" src="assets/images/product-images/boy3(2).jpg" alt="image" title="product">
                                                    <!-- End hover image -->
                                                </a>
                                                <!-- end product image -->
                                            ...
                                            <div class="product-details text-center">
                                                <!-- product name -->
                                                <div class="product-name">
                                                    <a href="short-description.html">Boy School Uniform Short - Banded</a>
                                                </div>
                                                <!-- End product name -->
                                                <!-- product price -->
                                                <div class="product-price">
                                        ...
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="short-description.html">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload" data-src="assets/images/product-images/boy4(1).jpg" src="assets/images/product-images/boy4(1).jpg" alt="image" title="product">
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload" data-src="assets/images/product-images/boy2(2).jpg" src="assets/images/product-images/boy2(2).jpg" alt="image" title="product">
                                                    <!-- End hover image -->
                                            ...
                                            <div class="product-details text-center">
                                                <!-- product name -->
                                                <div class="product-name">
                                                    <a href="short-description.html">Boy School Uniform Shirt - Long Sleeve</a>
                                                </div>
                                                <!-- End product name -->
                                                <!-- product price -->
                                                <div class="product-price">
                                                    <span class="price">LKR 1095.00 - LKR 1595.00</span>
                                                </div>
                                                <!-- End product price -->
                                        ...
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="short-description.html">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload" data-src="assets/images/product-images/trouser1(1).jpg" src="assets/images/product-images/trouser1(1).jpg" alt="image" title="product">
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload" data-src="assets/images/product-images/trouser1(2).jpg" src="assets/images/product-images/trouser1(2).jpg" alt="image" title="product">
                                                    <!-- End hover image -->
                                                </a>
                                                <!-- end product image -->
                                            ...
                                            <div class="product-details text-center">
                                                <!-- product name -->
                                                <div class="product-name">
                                                    <a href="short-description.html">Boy School Uniform White Trouser</a>
                                                </div>
                                                <!-- End product name -->
                                                <!-- product price -->
                                                <div class="product-price">
                                                    <span class="price">LKR 1995.00 - LKR 2495.00</span>
                                                </div>
                                                <!-- End product price -->
                                    ...
                                    <div class="productSlider">
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="short-description.html">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload" data-src="assets/images/product-images/socks1(1).jpg" src="assets/images/product-images/socks1(1).jpg" alt="image" title="product">
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload" data-src="assets/images/product-images/socks1(2).jpg" src="assets/images/product-images/socks1(2).jpg" alt="image" title="product">
                                                    <!-- End hover image -->
                                                </a>
                                                <!-- end product image -->
                                            ...
                                            <div class="product-details text-center">
                                                <!-- product name -->
                                                <div class="product-name">
                                                    <a href="short-description.html">School Socks - White</a>
                                                </div>
                                                <!-- End product name -->
                                                <!-- product price -->
                                                <div class="product-price">
                                                    <span class="price">LKR 295.00</span>
                                                </div>
                                                <!-- End product price -->
                                        ...
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="short-description.html">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload" data-src="assets/images/product-images/socks2(1).jpg" src="assets/images/product-images/socks2(1).jpg" alt="image" title="product">
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload" data-src="assets/images/product-images/socks2(2).jpg" src="assets/images/product-images/socks2(2).jpg" alt="image" title="product">
                                                    <!-- End hover image -->
                                                </a>
                                                <!-- end product image -->
                                            ...
                                            <div class="product-details text-center">
                                                <!-- product name -->
                                                <div class="product-name">
                                                    <a href="short-description.html">School Socks - Black</a>
                                                </div>
                                                <!-- End product name -->
                                                <!-- product price -->
                                                <div class="product-price">
                                        ...
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="short-description.html">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload" data-src="assets/images/product-images/socks3(1).jpg" src="assets/images/product-images/socks3(1).jpg" alt="image" title="product">
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload" data-src="assets/images/product-images/socks3(2).jpg" src="assets/images/product-images/socks3(2).jpg" alt="image" title="product">
                                                    <!-- End hover image -->
                                                </a>
                                                <!-- end product image -->
                                            ...
                                            <div class="product-details text-center">
                                                <!-- product name -->
                                                <div class="product-name">
                                                    <a href="short-description.html">School Socks - Black / Gray Sole</a>
                                                </div>
                                                <!-- End product name -->
                                                <!-- product price -->
                                                <div class="product-price">
                                                    <span class="price">LKR 395.00</span>
                                                </div>
                                                <!-- End product price -->
                                        ...
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="short-description.html">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload" data-src="assets/images/product-images/boyvest(1).jpg" src="assets/images/product-images/boyvest(1).jpg" alt="image" title="product">
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload" data-src="assets/images/product-images/boysvest(3).jpg" src="assets/images/product-images/boysvest(3).jpg" alt="image" title="product">
                                                    <!-- End hover image -->
                                                </a>
                                                <!-- end product image -->
                                            ...
                                            <div class="product-details text-center">
                                                <!-- product name -->
                                                <div class="product-name">
                                                    <a href="short-description.html">Boys Vest</a>
                                                </div>
                                                <!-- End product name -->
                                                <!-- product price -->
                                                <div class="product-price">
                                                    <span class="price">LKR 595.00</span>
                                                </div>
                                                <!-- End product price -->
                                        ...
                                        <div class="col-12 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="short-description.html">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload" data-src="assets/images/product-images/girlsvest1(1).jpg" src="assets/images/product-images/girlsvest1(1).jpg" alt="image" title="product">
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload" data-src="assets/images/product-images/girlsvest1(2).jpg" src="assets/images/product-images/girlsvest1(2).jpg" alt="image" title="product">
                                                    <!-- End hover image -->
                                                </a>
                                                <!-- end product image -->
                                            ...
                                            <div class="product-details text-center">
                                                <!-- product name -->
                                                <div class="product-name">
                                                    <a href="short-description.html">School Girl ’s Petticoat White Cotton Vest Top</a>
                                                </div>
                                                <!-- End product name -->
                                                <!-- product price -->
                                                <div class="product-price">
                                                    <span class="price">LKR 495.00 - LKR 595.00</span>
                                                </div>
                                                <!-- End product price -->
				...
				<div class="collection-grid">
                        <div class="collection-grid-item">
                            <a href="collection-page.html" class="collection-grid-item__link">
                                <img data-src="assets/images/collection/shirt1.jpg" src="assets/images/collection/shirt1.jpg" alt="Fashion" class="blur-up lazyload"/>
                                <div class="collection-grid-item__title-wrapper">
                                    <h3 class="collection-grid-item__title btn btn--secondary no-border">Short-Sleeve Shirt</h3>
                                </div>
                            </a>
                        </div>
                        <div class="collection-grid-item">
                            <a href="collection-page.html" class="collection-grid-item__link">
                                <img class="blur-up lazyload" data-src="assets/images/collection/trouser2.jpg" src="assets/images/collection/trouser2.jpg" alt="Cosmetic"/>
                                <div class="collection-grid-item__title-wrapper">
                                    <h3 class="collection-grid-item__title btn btn--secondary no-border">White Trouser</h3>
                                </div>
                            </a>
                        </div>
                        <div class="collection-grid-item blur-up lazyloaded">
                            <a href="collection-page.html" class="collection-grid-item__link">
                                <img data-src="assets/images/collection/frock3.jpg" src="assets/images/collection/frock3.jpg" alt="Bag" class="blur-up lazyload"/>
                                <div class="collection-grid-item__title-wrapper">
                                    <h3 class="collection-grid-item__title btn btn--secondary no-border">Frock</h3>
                                </div>
                            </a>
                        </div>
                        <div class="collection-grid-item">
                            <a href="collection-page.html" class="collection-grid-item__link">
                                <img data-src="assets/images/collection/short44.jpg" src="assets/images/collection/short44.jpg" alt="Accessories" class="blur-up lazyload"/>
                                <div class="collection-grid-item__title-wrapper">
                                    <h3 class="collection-grid-item__title btn btn--secondary no-border">Shorts</h3>
                                </div>
                            </a>
                        </div>
                        <div class="collection-grid-item">
                            <a href="collection-page.html" class="collection-grid-item__link">
                                <img data-src="assets/images/collection/lsshirt5.jpg" src="assets/images/collection/lsshirt5.jpg" alt="Shoes" class="blur-up lazyload"/>
                                <div class="collection-grid-item__title-wrapper">
                                    <h3 class="collection-grid-item__title btn btn--secondary no-border">Long-Sleeve Shirt</h3>
                                </div>
                            </a>
                        </div>
                        <div class="collection-grid-item">
                            <a href="collection-page.html" class="collection-grid-item__link">
                                <img data-src="assets/images/collection/socks6.jpg" src="assets/images/collection/socks6.jpg" alt="Jewellry" class="blur-up lazyload"/>
                                <div class="collection-grid-item__title-wrapper">
                                    <h3 class="collection-grid-item__title btn btn--secondary no-border">Socks</h3>
                                </div>
                            </a>
                        </div>
                    </div>
            	...
            	<div class="row">
                	<div class="col-12 col-sm-12 col-md-12 col-lg-12">
                		<div class="logo-bar">
                            ...
                            <div class="section-header text-center">
                                <h2 class="h2">Our Supplying Partner</h2>
                                <div class="logo-bar__item">
                                    <img src="assets/images/logo/brandlogo7.jpg" alt="" title="" />
                                    <img src="assets/images/logo/japanseal.jpg" alt="" title="" />
                                </div>
	                ...
	                <div class="row">
                        <div class="col-6 col-sm-6 col-md-4 col-lg-4 item grid-view-item style2">
                        	<div class="grid-view_image">
                                ...
                                <a href="product-accordion.html" class="grid-view-item__link">
                                    <!-- image -->
                                    <img class="grid-view-item__image primary blur-up lazyload" data-src="assets/images/product-images/ld1(2).jpg" src="assets/images/product-images/ld1(2).jpg" alt="image" title="product">
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="grid-view-item__image hover blur-up lazyload" data-src="assets/images/product-images/ld1(1).jpg" src="assets/images/product-images/ld1(1).jpg" alt="image" title="product">
                                    <!-- End hover image -->
                                    <!-- product label -->
                                    <div class="product-labels rectangular"><span class="lbl on-sale">-16%</span> <span class="lbl pr-label1">new stock</span></div>
                                    <!-- End product label -->
                                </a>
                                <!-- end product image -->
                                <!--start product details -->
                                <div class="product-details hoverDetails text-center mobile">
                                    <!-- product name -->
                                    <div class="product-name">
                                        <a href="product-accordion.html">Girl's School Uniform Frock - GSC</a>
                                    </div>
                                    <!-- End product name -->
                                    <!-- product price -->
                                    <div class="product-price">
                        ...
                        <div class="col-6 col-sm-6 col-md-4 col-lg-4 item grid-view-item style2">
                        	<div class="grid-view_image">
                                ...
                                <a href="product-accordion.html" class="grid-view-item__link">
                                    <!-- image -->
                                    <img class="grid-view-item__image primary blur-up lazyload" data-src="assets/images/product-images/boy1(1).jpg" src="assets/images/product-images/boy1(1).jpg" alt="image" title="product">
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="grid-view-item__image hover blur-up lazyload" data-src="assets/images/product-images/boy1(2).jpg" src="assets/images/product-images/boy1(2).jpg" alt="image" title="product">
                                    <!-- End hover image -->
                                    <!-- product label -->
                                    <div class="product-labels rectangular"><span class="lbl pr-label1">new stock</span></div>
                                    <!-- End product label -->
                                </a>
                                <!-- end product image -->
                                <!--start product details -->
                                <div class="product-details hoverDetails text-center mobile">
                                    <!-- product name -->
                                    <div class="product-name">
                                        <a href="product-accordion.html">Boys School Uniform Short - Elasticated</a>
                                    </div>
                                    <!-- End product name -->
                                    <!-- product price -->
                                    <div class="product-price">
                        ...
                        <div class="col-6 col-sm-6 col-md-4 col-lg-4 item grid-view-item style2">
                        	<div class="grid-view_image">
                                ...
                                <a href="product-accordion.html" class="grid-view-item__link">
                                    <!-- image -->
                                    <img class="grid-view-item__image primary blur-up lazyload" data-src="assets/images/product-images/boy2(1).jpg" src="assets/images/product-images/boy2(1).jpg" alt="image" title="product">
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="grid-view-item__image hover blur-up lazyload" data-src="assets/images/product-images/boy2(2).jpg" src="assets/images/product-images/boy2(2).jpg" alt="image" title="product">
                                    <!-- End hover image -->
                                    <!-- product label -->
                                    <div class="product-labels rectangular"><span class="lbl pr-label1">new stock</span></div>
                                    <!-- End product label -->
                                ...
                                <div class="product-details hoverDetails text-center mobile">
                                    <!-- product name -->
                                    <div class="product-name">
                                        <a href="product-accordion.html">Boy School Unifrom Shirt - Short-Sleeve</a>
                                    </div>
                                    <!-- End product name -->
                                    <!-- product price -->
                                    <div class="product-price">
                        ...
                        <div class="col-6 col-sm-6 col-md-4 col-lg-4 item grid-view-item style2">
                        	<div class="grid-view_image">
                                ...
                                <a href="product-accordion.html" class="grid-view-item__link">
                                    <!-- image -->
                                    <img class="grid-view-item__image primary blur-up lazyload" data-src="assets/images/product-images/boy3(1).jpg" src="assets/images/product-images/boy3(1).jpg" alt="image" title="product">
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="grid-view-item__image hover blur-up lazyload" data-src="assets/images/product-images/boy3(2).jpg" src="assets/images/product-images/boy3(2).jpg" alt="image" title="product">
                                    <!-- End hover image -->
                                    <!-- product label -->
                                    <div class="product-labels"><span class="lbl on-sale">Sale</span></div>
                                    <!-- End product label -->
                                ...
                                <div class="product-details hoverDetails text-center mobile">
                                    <!-- product name -->
                                    <div class="product-name">
                                        <a href="product-accordion.html">Boy School Uniform Short - Banded</a>
                                    </div>
                                    <!-- End product name -->
                                    <!-- product price -->
                                    <div class="product-price">
                        ...
                        <div class="col-6 col-sm-6 col-md-4 col-lg-4 item grid-view-item style2">
                        	<div class="grid-view_image">
                                ...
                                <a href="product-accordion.html" class="grid-view-item__link">
                                    <!-- image -->
                                    <img class="grid-view-item__image primary blur-up lazyload" data-src="assets/images/product-images/Ig3(1).jpg" src="assets/images/product-images/Ig3(1).jpg" alt="image" title="product">
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="grid-view-item__image hover blur-up lazyload" data-src="assets/images/product-images/Ig3(2).jpg" src="assets/images/product-images/Ig3(2).jpg" alt="image" title="product">
                                    <!-- End hover image -->
                                    <!-- product label -->
                                    <div class="product-labels rectangular"><span class="lbl pr-label2">Out of Stock</span></div>
                                    <!-- End product label -->
                                ...
                                <div class="product-details hoverDetails text-center mobile">
                                    <!-- product name -->
                                    <div class="product-name">
                                        <a href="product-accordion.html">Girl's School Unifrom Forck - Meseus</a>
                                    </div>
                                    <!-- End product name -->
                                    <!-- product price -->
                                    <div class="product-price">
                                        <span class="price">LKR 1095.00 - 1995.00</span>
                                    </div>
                                    <!-- product button -->
                                    <div class="button-set">
                                        <a href="javascript:void(0)" title="Quick View" class="quick-view-popup quick-view" data-toggle="modal" data-target="#content_quickview">
                        ...
                        <div class="col-6 col-sm-6 col-md-4 col-lg-4 item grid-view-item style2">
                        	<div class="grid-view_image">
                                ...
                                <a href="product-accordion.html" class="grid-view-item__link">
                                    <!-- image -->
                                    <img class="grid-view-item__image primary blur-up lazyload" data-src="assets/images/product-images/Ig2(1).jpg" src="assets/images/product-images/Ig2(1).jpg" alt="image" title="product">
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="grid-view-item__image hover blur-up lazyload" data-src="assets/images/product-images/Ig2(2).jpg" src="assets/images/product-images/Ig2(2).jpg" alt="image" title="product">
                                    <!-- End hover image -->
                                </a>
                                <!-- end product image -->
                                <!--start product details -->
                                <div class="product-details hoverDetails text-center mobile">
                                    <!-- product name -->
                                    <div class="product-name">
                                        <a href="product-accordion.html">Girl's School Uniform Frock - Normal Pleat</a>
                                    </div>
                                    <!-- End product name -->
                                    <!-- product price -->
                                    <div class="product-price">
                    	...
                    	<ul class="display-table store-info">
                        	<li class="display-table-cell">
                          	...
                          	<li class="display-table-cell">
                                ...
                                <span class="sub-text">7 days money back guarantee</span>
                          	</li>
                          	<li class="display-table-cell">
        ...
        <div class="site-footer">
        	<div class="container">
                	...
                	<div class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-3 col-lg-3 contact-box">
                            ...
                            <ul class="addressFooter">
                            	<li><i class="icon anm anm-map-marker-al"></i><p>No. 14,<br>King steet,<br>Badulla, Sri Lanka <br>90000</p></li>
                                <li class="phone"><i class="icon anm anm-phone-s"></i><p>(055) 222 3599</p></li>
                                <li class="email"><i class="icon anm anm-envelope-l"></i><p>jhansunifsl@gmail.com</p></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="footer-bottom">
                	<div class="row">
                    	<!--Footer Copyright-->
	                	<div class="col-12 col-sm-12 col-md-6 col-lg-6 order-1 order-md-0 order-lg-0 order-sm-1 copyright text-sm-center text-md-left text-lg-left"><span></span>  &copy; Copyright <strong><span>Jhan's Unifrom Store 2023</span></strong>. All Rights Reserved</div>
	...
	<div class="newsletter-wrap" id="popup-container">
      <div id="popup-window">
        ...
        <div class="display-table splash-bg">
          <div class="display-table-cell width40"><img src="assets/images/slideshow-banners/jhanslogo1.png" alt="Join Our Mailing List" title="Join Our Mailing List" /> </div>
